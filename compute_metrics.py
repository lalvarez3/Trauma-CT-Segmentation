...
# TASK = "Task511_SpleenTraumaCV"

paths_to_analyze = glob.glob(os.path.join(HOME, "lauraalvarez", "nnunet", "nnUNet_raw_data", TASK, "out_unet/*.json"))
...
# get filename
    ...
    csv_path = os.path.join(HOME, "lauraalvarez", "nnunet", "nnUNet_raw_data/", TASK ,'out_unet', filename)
